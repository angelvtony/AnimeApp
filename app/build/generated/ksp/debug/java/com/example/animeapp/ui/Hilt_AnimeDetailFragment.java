...
public abstract class Hilt_AnimeDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AnimeDetailFragment() {
    super();
  }

  Hilt_AnimeDetailFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AnimeDetailFragment_GeneratedInjector) this.generatedComponent()).injectAnimeDetailFragment(UnsafeCasts.<AnimeDetailFragment>unsafeCast(this));
    }
  }
