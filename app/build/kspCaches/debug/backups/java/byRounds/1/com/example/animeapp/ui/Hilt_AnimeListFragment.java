...
public abstract class Hilt_AnimeListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AnimeListFragment() {
    super();
  }

  Hilt_AnimeListFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AnimeListFragment_GeneratedInjector) this.generatedComponent()).injectAnimeListFragment(UnsafeCasts.<AnimeListFragment>unsafeCast(this));
    }
  }
